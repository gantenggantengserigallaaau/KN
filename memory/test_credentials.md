...
| `dewi.printing@kainnusantara.id` | sales | `ent_ksc` | **FASE L** — akun BERPAGAR LINI (`allowed_line_codes=["printing"]`): hanya melihat produk/pesanan/roll lini printing, dan ditolak 403 saat menambahkan kain woven ke pesanan |
